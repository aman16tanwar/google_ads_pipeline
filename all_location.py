...
TABLE_ID = f"{GCP_PROJECT_ID}.{os.getenv('BIGQUERY_DATASET_ALL_MAIN')}.{os.getenv('BIGQUERY_TABLE_ALL_LOCATION')}"
...
def main():
    ...
    to_gbq(df_all, destination_table=TABLE_ID, project_id=GCP_PROJECT_ID, credentials=credentials, if_exists="append")
...
#     # Step 2: Initialize GoogleAdsClient
#     client = GoogleAdsClient.load_from_dict(config)

#     # Step 3: Pick a valid client account ID (from fetch_enabled_accounts if needed)
#     customer_id = "8759072899"  # Must be a string

#     # Step 4: Fetch location data
#     df = get_location_conversions(client, customer_id)

#     # Step 5: Debug or Upload
#     if df.empty:
#         print("No location data found.")
#     else:
#         print(f"Fetched {len(df)} rows.")
#         # Step 6: TO DO: Upload to BigQuery
...
# if __name__ == "__main__":
#     account= fetch_enabled_accounts()
#     if not account:
#         print("No enabled accounts found.")
#     else:
#         print(f"Enabled accounts: {account}")
